...
export class updateUser31620618423191 implements MigrationInterface {
    name = 'updateUser31620618423191'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_groups_group" ADD "userId" character varying NOT NULL`);
